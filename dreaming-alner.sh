...
POLICY_PATHS=( conll2002_policy.ckpt )
...
POLICY_PATH=$ROOT_DIR'results/conll2002_eps_20191106-170633/'${POLICY_PATHS[$policy_idx]}
...
cd $SRC_PATH && python3 AL-crf-dreaming.py --root_dir $ROOT_DIR --dataset_name $DATASET_NAME  \
    --train_file $TEXT_DATA_DIR/$TRAIN_FILE --dev_file $TEXT_DATA_DIR/$DEV_FILE \
    --test_file $TEXT_DATA_DIR/$TESTS_FILE \
    --policy_path $POLICY_PATH\
    --word_vec_file $EMBEDING_FILE --episodes 1 --timesteps 5 \
